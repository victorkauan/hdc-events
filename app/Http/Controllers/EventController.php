...
class EventController extends Controller
{
    ...
    public function joinEvent($id) {
        ...
        return redirect('/dashboard')->with('msg', "Your presence is confirmed in event: $event->title");
    }
    ...
    public function leaveEvent($id) {
        ...
        return redirect('/dashboard')->with('msg', "You successfully exited event: $event->title");
    }
}
